...
<script type="text/javascript" src="<?= media(); ?>/js/plugins/fullcalendar.min.js"></script>
<script type="text/javascript" src="<?= media(); ?>/js/plugins/moment-timezone-with-data.min.js"></script>
