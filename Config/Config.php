<?php
const BASE_URL = "http://localhost/clinica_dental";
...
const NOMBRE_REMITENTE = "Clínica Dental";
const EMAIL_REMITENTE = "no-reply@abelosh.com";
const NOMBRE_EMPESA = "Clínica Dental";
...
const MDSERVICIO = 15;
const MDCITA = 16;
const MDHISTORIAL = 13;
const MDRECORDATORIO = 14;
