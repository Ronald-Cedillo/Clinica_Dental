...
class UsuariosModel extends Mysql
{
	...
	public function selectUsuarios()
	{
		...
		$sql = "SELECT p.idpersona,p.identificacion,p.nombres,p.apellidos, CONCAT(p.nombres, ' ', p.apellidos) AS nombre_completo,p.telefono,p.email_user,p.status,r.idrol,r.nombrerol 
					FROM persona p 
					INNER JOIN rol r
					ON p.rolid = r.idrol
